...
<body text="#000000"  leftmargin="0" background="images/bg.gif" topmargin="0" marginheight="0" marginwidth="0">
  <div class="container">
    <!-- navbar-->
        <div class="row">
        ...
        <nav class="navbar sticky-top navbar-expand-lg  navbar-dark rounded-5 bg-primary text-white">                 
          ...
          <div class="collapse navbar-collapse" id="navbarNavDropdown">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="details.php">About Tarnetar Fair</a>
              </li>
          ...
          <a href="index.php" id="log" class="float-md-right text-white">Tarnetar Fair 2023</a>
